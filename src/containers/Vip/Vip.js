  ...
  render() {
    ...
    return (
      <>
        ...
        <p>
          Note: This calculation might vary from the actual price because of the
          source of conversion. This calculation does not include tax. So it
          might change depending on your payment method.
        </p>
        <div>
          <span>Currency </span>
          <CurrencyDropdown
